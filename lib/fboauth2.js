...
FBOAuth2.prototype.confirmIdentity = function(code, cb){
  ...
  sails.log.debug(accessTokenURI)
...
FBOAuth2.prototype.get = function(uri, cb){
  ...
  var url = this._graphAPIURL + uri + '?' + this.toQuery(this.accessToken) + '&fields=name,first_name,last_name,gender,email,birthday,education,work,location,picture.width(9999)';
  request(url, cb);
};